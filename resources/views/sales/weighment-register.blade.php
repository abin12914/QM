                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control prevent-edit" name="date" id="date" title="Do not edit this field" tabindex="22"  value="{{ Carbon\Carbon::parse($sale->date_time)->format('d-m-Y H:m:i') }}">
                                                </div>
