@extends('layouts.app')
@section('title', 'Excavator Updation')
@section('content')
<div class="content-wrapper">
     <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Excavator Updation</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title" style="float: left;">Excavator Updation</h3>
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{route('excavator-register-action')}}" method="post" class="form-horizontal">
                        <div class="box-body">
