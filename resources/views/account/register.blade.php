                            ...
                            <div class="row">
                                <div class="col-md-11">
                                    <div class="{{ !empty($errors->first('name')) ? 'form-group has-error' : 'form-group' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="name" class="form-control" id="name" placeholder="Name" value="{{ old('name') }}" required tabindex="1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="financial_status" id="financial_status" required tabindex="5">
                                                ...
                                                <option value="none" {{ (old('account_type') == 'none') ? 'selected' : '' }}>None (No pending transactions)</option>
                                                <option value="credit" {{ (old('account_type') == 'credit') ? 'selected' : '' }}>Debitor (Account holder owe company)</option>
                                                <option value="debit" {{ (old('account_type') == 'debit') ? 'selected' : '' }}>Creditor (Company owe account holder)</option>
                                            </select>
