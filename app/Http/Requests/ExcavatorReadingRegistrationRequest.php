...
class ExcavatorReadingRegistrationRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'excavator_operator_account_id.required'    => 'Operator name field is required.',
            'excavator_operator_account_id.max'         => 'Something went wrong. Please try again after reloading the page.',
            'excavator_operator_account_id.min'         => 'Something went wrong. Please try again after reloading the page.',
