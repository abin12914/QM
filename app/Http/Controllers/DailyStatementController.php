...
class DailyStatementController extends Controller
{
    ...
    public function register()
    {
        ...
        $employeeAttendance = EmployeeAttendance::where('date',$today)->get();
    ...
    public function employeeAttendanceAction(EmployeeAttendanceRegistrationRequest $request)
    {
        ...
        if(!empty($recordFlag)) {
            return redirect()->back()->with("message","Error! This user already marked.")->with("alert-class","alert-danger");
        }
